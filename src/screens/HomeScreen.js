...
import VIDEOJUEGOS from '../data/datos.json';
    ...
    return (
        ...
        <View style={styles.header}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Carrito')}>
                <View style={{ backgroundColor: '#171717', padding: 12, borderRadius: 25 }}>
        ...
        <FlatList 
            ...
            renderItem={({ item }) => (
                <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate('Detalles', { juego: item })} >
